...
For a released installation, use the verified Compose bundle from the
[ApiaryLens Public Preview 1 release page](../docs/releases/0.1.0-preview.1.md).
Scout Bee is coming soon and is not required. The direct procedure below verifies
the deployment identity and keeps the self-hosted path available today.
