...
```powershell
Get-FileHash .\apiarylens-scout-bee-0.1.0-rc.1-windows-amd64.exe -Algorithm SHA256
gh attestation verify .\apiarylens-scout-bee-0.1.0-rc.1-windows-amd64.exe `
