...
```powershell
Get-FileHash .\apiarylens-scout-bee-0.1.0-rc.2-windows-amd64.exe -Algorithm SHA256
gh attestation verify .\apiarylens-scout-bee-0.1.0-rc.2-windows-amd64.exe `
