...
const officialReleaseManifestURL = "https://apiarylens.org/releases/0.1.0-rc.2/manifest.json"
...
func (e *executor) releaseHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if err = json.Unmarshal(raw, &manifest); err != nil || manifest.Product != "ApiaryLens" || manifest.ProductVersion != productVersion {
